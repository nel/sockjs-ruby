...
Even though this library uses Rack interface, *Thin is required* as "it supports asynchronous callback":http://macournoyer.com/blog/2009/06/04/pusher-and-async-with-thin.
...
app = Rack::Builder.new do
  ...
  map "/echo" do
    run SockJS::Rack.new(EchoSession)
  end

  # ... and the other one on /close.
  map "/close" do
    run SockJS::Rack.new(CloseSession)
  end
...
For more complex example check "lib/sockjs/examples/sockjs_apps_for_sockjs_protocol_tests.rb"
